...
<div class="wrapper">
    <div class="detail-heading">Chỉnh sửa lịch thi</div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" value="{{ date('Y-m-d\TH:i', strtotime(old('NgayThi', isset($lichthi->NgayThi) ? $lichthi->NgayThi : ''))) }}" required name="NgayThi">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
